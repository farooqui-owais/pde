...
#
# USAGE
#   powershell -File sonar\scripts\stop-sonar.ps1            # keep data
#   powershell -File sonar\scripts\stop-sonar.ps1 -Purge     # DELETE all data
#
# After promotion the same command becomes:
...
Write-Host "    powershell -File sonar\scripts\start-sonar.ps1"
Write-Ok "==============================================================================="
